...
import { Shield, DollarSign, Flame, TrendingUp, CheckCircle, Award, LogOut, User as UserIcon, Copy, Check } from 'lucide-react';
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64">
                  <div className="px-2 py-2">
                    <p className="text-sm font-semibold text-white">@{user?.nickname || 'user'}</p>
                    <p className="text-xs text-gray-400">{user?.role || 'validator'}</p>
                  </div>
                  <DropdownMenuSeparator />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-lg text-gray-400">Ready to validate and earn USDC?</p>
          </div>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-[#54e6b6]/20 flex items-center justify-center">
                    <Shield className="w-5 h-5 text-[#54e6b6]" />
                  </div>
                  <div>
                    <CardDescription className="text-gray-400">Validations</CardDescription>
                    <CardTitle className="text-2xl text-white">{stats?.total_clips_validated || 0}</CardTitle>
                  </div>
                </div>
              </CardHeader>
            </Card>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="bg-gradient-to-br from-[#54e6b6]/10 to-transparent border-[#54e6b6]/30">
              <CardHeader>
                <CardTitle className="text-white">Validation Tasks</CardTitle>
                <CardDescription className="text-gray-400">Review and validate contributions</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center justify-between px-4 py-3 rounded-lg bg-gray-800/50 border border-gray-700">
                  ...
                  <span className="text-lg font-bold text-[#54e6b6]">0</span>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Your accuracy and consensus metrics</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4 rounded-lg bg-gray-900/50">
                  <p className="text-3xl font-bold text-[#54e6b6] mb-2">--</p>
                  <p className="text-sm text-gray-400">Accuracy Rate</p>
                </div>
                <div className="text-center p-4 rounded-lg bg-gray-900/50">
                  <p className="text-3xl font-bold text-[#54e6b6] mb-2">--</p>
                  <p className="text-sm text-gray-400">Consensus Match</p>
                </div>
                <div className="text-center p-4 rounded-lg bg-gray-900/50">
                  <p className="text-3xl font-bold text-[#54e6b6] mb-2">--</p>
                  <p className="text-sm text-gray-400">Avg. Time/Task</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-800/50 border-gray-700">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Your latest validation activity</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-gray-500">
                <Shield className="w-12 h-12 mx-auto mb-3 opacity-50" />
                <p>No validations yet. Start validating to see your activity here!</p>
              </div>
            </CardContent>
          </Card>
        </div>
